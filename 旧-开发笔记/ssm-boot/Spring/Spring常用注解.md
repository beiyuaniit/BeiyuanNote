...
- XML文件方式
  ...
  <beans xmlns="http://www.springframework.org/schema/beans"
     ...
     <context:component-scan base-package="com.beiyuan" use-default-filters="false"></context:component-scan>
     <bean id="person" class="com.beiyuan.bean.Person">
...
- @Import
  ...
  - 用于在配置类中导入其他的配置类或Bean定义，从而简化了配置的层次结构
  - 还可与`ImportSelector`或`ImportBeanDefinitionRegistrar`一起使用，提供更动态的Bean注册机制
  - @ComponentScan不是可以自动扫描包注册Bean？为什么还要手动导入Bean呢
